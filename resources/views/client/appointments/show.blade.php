...
@section('content')
    @php
        ...
        $backRoute = $isAdmin ? route('admin.appointments.index') : route('appointments.index');
    @endphp
    ...
    <div class="mx-auto max-w-4xl flex flex-col gap-8 animate-fade-up">
            ...
            <div class="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between relative z-10">
                <div class="flex flex-col gap-2">
                    <div class="flex items-center gap-3">
                        <span class="font-display text-[10px] font-bold uppercase tracking-[0.28em] text-luxury-gold">Détails du rendez-vous</span>
        ...
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <div class="rounded-3xl border border-white/10 bg-[#111113] p-6 sm:p-7 shadow-xl flex flex-col gap-6">
                ...
                <div class="space-y-3 pt-2">
                    ...
                    <div class="flex items-center justify-between rounded-xl border border-white/[0.06] bg-white/[0.02] p-3 text-xs">
                        ...
                        <span class="font-medium text-white">{{ $user->phone ?? 'Non renseigné' }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-3xl border border-white/10 bg-[#111113] p-6 sm:p-7 shadow-xl flex flex-col gap-6">
                <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                    ...
                    <div>
                        <h2 class="font-display text-base font-bold text-white">Informations de la réservation</h2>
                        <p class="text-xs text-luxury-secondary/70">Planning et détails du service</p>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between rounded-xl border border-white/[0.06] bg-white/[0.02] p-3 text-xs">
                        <span class="text-luxury-secondary">Barbier</span>
                        <span class="font-medium text-luxury-gold">Gentleman Maître Barbier</span>
                    </div>
        ...
        <div class="rounded-3xl border border-white/10 bg-[#111113] p-6 sm:p-8 shadow-xl flex flex-col gap-6">
            <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-luxury-secondary/70">Suivi des étapes</p>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                        ...
                        <div class="relative flex items-start gap-4">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <p class="text-xs text-luxury-secondary/70 mt-1">Réservation soumise et enregistrée.</p>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                        ...
                        <div class="relative flex flex-col items-start gap-2">
                            ...
                            <div class="pl-13 flex flex-col gap-0.5">
                                <span class="text-xs text-luxury-secondary">{{ $appointment->created_at->locale('fr')->isoFormat('D MMM YYYY [à] HH:mm') }}</span>
                                <span class="text-[11px] text-emerald-400 font-medium mt-1">Finalisé</span>
                            </div>
                        </div>
                        ...
                        <div class="relative flex flex-col items-start gap-2">
                            ...
                            <div class="pl-13 flex flex-col gap-0.5">
                                ...
                                <span class="text-[11px] font-medium mt-1 {{ $isConfirmed ? 'text-emerald-400' : ($isCurrentConfirmed ? 'text-amber-400' : 'text-white/40') }}">
                                    {{ $isConfirmed ? 'Finalisé' : ($isCurrentConfirmed ? 'En cours' : 'En attente') }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="relative flex flex-col items-start gap-2">
                            ...
                            <div class="pl-13 flex flex-col gap-0.5">
                                <span class="text-xs text-luxury-secondary">
                                    {{ $isCompleted ? $appointment->updated_at->locale('fr')->isoFormat('D MMM YYYY [à] HH:mm') : 'Réalisation du soin' }}
                                </span>
        ...
        <div class="rounded-3xl border border-white/10 bg-[#111113] p-6 sm:p-7 shadow-xl flex flex-col gap-4">
            <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                ...
                <div>
                    <h2 class="font-display text-base font-bold text-white">Remarques</h2>
        ...
        <div class="rounded-3xl border border-white/10 bg-[#111113] p-6 sm:p-8 shadow-xl flex flex-col gap-5">
            <div class="flex flex-col gap-1">
                <h2 class="font-display text-base font-bold text-white">Actions disponibles</h2>
                <p class="text-xs text-luxury-secondary/70">Gérer ou modifier ce rendez-vous</p>
            </div>
            ...
            <div class="flex flex-wrap items-center gap-4 pt-2">
                ...
                @else
                    <!-- Client Actions -->
                    @if ($status === 'pending')
                        <a href="{{ route('appointments.create') }}" class="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-6 py-3 font-display text-xs font-bold uppercase tracking-widest text-white transition-all duration-300 hover:border-luxury-gold/50 hover:bg-white/10 hover:text-luxury-gold">
                            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                    ...
                    @elseif($status === 'completed')
                        <button onclick="window.print()" class="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-6 py-3 font-display text-xs font-bold uppercase tracking-widest text-white transition-all duration-300 hover:border-luxury-gold/50 hover:bg-white/10 hover:text-luxury-gold cursor-pointer">
                            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif($status === 'cancelled')
                        <a href="{{ route('appointments.create') }}" class="inline-flex items-center justify-center gap-2 rounded-full bg-luxury-gold px-6 py-3 font-display text-xs font-bold uppercase tracking-widest text-luxury-bg transition-all duration-300 hover:bg-white shadow-md">
                            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
