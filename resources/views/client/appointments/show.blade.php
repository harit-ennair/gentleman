...
@section('content')
    ...
    <div class="mx-auto max-w-4xl flex flex-col gap-8 animate-fade-up">
            ...
            <div class="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between relative z-10">
                <div class="flex flex-col gap-2">
                    <div class="flex items-center gap-3">
                        <span class="font-display text-[10px] font-bold uppercase tracking-[0.28em] text-luxury-gold">Appointment Details</span>
        ...
        <div class="rounded-3xl border border-white/10 bg-[#111113] p-6 sm:p-8 shadow-xl flex flex-col gap-5">
            <div class="flex flex-col gap-1">
                <h2 class="font-display text-base font-bold text-white">Available Actions</h2>
                <p class="text-xs text-luxury-secondary/70">Manage or modify this appointment</p>
            </div>
