    ...
    <div class="flex flex-col gap-8 animate-fade-up">
        ...
        <header class="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            <div class="flex flex-col gap-2">
                <span class="font-display text-[10px] font-bold uppercase tracking-[0.28em] text-luxury-gold">Craftsmanship & Care</span>
                <h1 class="font-display text-3xl font-black tracking-tight text-white sm:text-4xl">Grooming Services</h1>
                <p class="text-sm text-luxury-secondary max-w-xl">Tailored haircuts, luxury shaves, and premium beard treatment crafted by master barbers.</p>
            </div>
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <p class="text-xs text-luxury-secondary line-clamp-3 leading-relaxed font-light">
                                {{ $service->description ?? 'Premium grooming treatment customized to your personal style and preferences.' }}
                            </p>
                        </div>
                    </div>
